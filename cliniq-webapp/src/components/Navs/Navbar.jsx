...
function NavBar() {
    ...
    return(
        ...
        <div className="p-2 bg-[#6da9e9] flex justify-around items-center sticky top-[-1px] z-30">
            <div>
                <img className="cursor-pointer" src={Logo} alt='Logo' style={{width: '50px', height: '50px'}} onClick={() => {navigate("/")}}/>
            </div>
            <Link to='/' className="flex-[0.7] md:text-2xl  font-bold text-white outline-none">
                CLINIQ
            </Link>
            <div className="hidden md:block">
                <NavBarLink arr={['Home', 'Services', 'Booking', 'About Us', 'Contact Us']}></NavBarLink>
            </div>
            ...
            <div className="md:hidden">
                <div id="menu" className={navBarMobileStyle}>
                    <NavBarLink arr={['Home', 'Services', 'Booking', 'About Us', 'Contact Us']} />
                    {loggedIn ? (
